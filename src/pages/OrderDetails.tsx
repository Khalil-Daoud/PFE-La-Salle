...
import { ArrowLeft, Package, MapPin, CreditCard, ShoppingBag, FileText } from 'lucide-react';
...
const OrderDetails: React.FC = () => {
  ...
  if (isLoading) return <div className="text-center py-16">Chargement des détails de la commande...</div>;
  if (error) {
    toast.error('Échec du chargement des détails de la commande');
    return <div className="text-center py-16">Erreur lors du chargement de la commande</div>;
  }
